    ...
    <div class="footer__blocks">
      <div class="footer__block footer__block--first">
        ...
        <div class="footer__icons">
          <div class="footer__icon" tabindex="0">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
      ...
      <div class="footer__block">
        <div class="footer__title footer__title--other">Company info</div>
        <div class="footer__options">
          <a href="#" class="footer__option">About Us</a>
          <a href="#" class="footer__option">Carrier</a>
          <a href="#" class="footer__option">We are hiring</a>
          <a href="#" class="footer__option">Blog</a>
        </div>
      </div>
      <div class="footer__block">
        <div class="footer__title footer__title--other">Features</div>
        <div class="footer__options">
          <a href="#" class="footer__option">Business Marketing</a>
          <a href="#" class="footer__option">User Analytic</a>
          <a href="#" class="footer__option">Live Chat</a>
          <a href="#" class="footer__option">Unlimited Support</a>
        </div>
      </div>
      <div class="footer__block">
        <div class="footer__title footer__title--other">Resources</div>
        <div class="footer__options">
          <a href="#" class="footer__option">IOS & Android</a>
          <a href="#" class="footer__option">Watch a Demo</a>
          <a href="#" class="footer__option">Customers</a>
          <a href="#" class="footer__option">API</a>
        </div>
      </div>
    </div>
  </div>
